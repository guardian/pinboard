...
export const userHasPermission = (userEmail: string) => s3Client.getObject({
  ...
  return !!permissions.find(_ =>
    _.permission.app === "pinboard"
    && _.permission.name === "pinboard"
    && _.overrides.find(override => override.userId === userEmail && override.active)
  );
