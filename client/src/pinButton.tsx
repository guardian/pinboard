...
const AddToPinboardButton = (props: AddToPinboardButtonProps) => (
  <button className="btn btn--deep" onClick={() => alert(JSON.stringify(props.dataAttributes, null, "  "))}>
    📌 Add to pinboard
  </button>
)
...
export const ButtonPortal = ({node}: ButtonPortalProps) => ReactDOM.createPortal(
