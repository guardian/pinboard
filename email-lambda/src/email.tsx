...
export const basicMessage = "You might have missed...";
...
export const EmailBody = (perPersonDetails: PerPersonDetails) => (
  ...
  >
    <h2 style={{ marginBottom: "8px" }}>{basicMessage}</h2>
    ...
    <div style={{ fontStyle: "italic" }}>
      The working titles (WT) and headlines (HL) above were accurate at the time
      this email was sent.
    </div>
    <h3
      style={{
